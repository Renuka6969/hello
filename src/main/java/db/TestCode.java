...
public class TestCode {
	...
	{	
		...
		createCustomer(connection, "Henry", "Den", "penry.doe@example.com", "103-457-7890", "123 Main St, Anytown, USA");
    ...
    private static final String JDBC_URL = "jdbc:postgresql://localhost:5432/emp";
